...
function getJson(url) {
  ...
  $.ajax({
      ...
      success: function(json) {
        ...
        $("#weather-high").html("celcius: " + Math.round(json.daily.data[0].temperatureMax) + " °c");
        $("#weather-fahrenheit").html("fahrenheit: " + Math.round(json.daily.data[0].temperatureMax * 9 / 5 + 32) + " °f");
        $("#weather-windspeed").html("Wind Speed : " + json.currently.windSpeed + " m/s");
        $('#weather-description').html("Description : " + json.currently.summary);
      }
...
function displayWeather(object){
  weatherIcon.src = "images/" + weatherImages[json.currently.summary] ;
}
